 ...
 * @author Software
 */
public class ViewPatientDoc extends javax.swing.JFrame {
...
//--patient_AdmissionDate varchar(20) not null,
        String columns = "patient_Id AS ID, patient_Name AS Name, patient_Gender, patient_Diagnosis AS Diagnosis, patient_Prescription AS Prescription, patient_TestResults AS TestRESULTS,  patient_AdmissionDate, patient_DischargeDate";
...
//
   ...
   /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AddPatientDoc addPatientDoc = new AddPatientDoc();
        addPatientDoc.setVisible(true);
        addPatientDoc.setLocationRelativeTo(null);
