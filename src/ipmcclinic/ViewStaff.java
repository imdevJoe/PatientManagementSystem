...
public class ViewStaff extends javax.swing.JFrame {
    ...
    public MyTableModel loadTableData() {
        ...
        tbModel = SQLServer.selectData("staff");
        return tbModel;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String id = JOptionPane.showInputDialog(null, "Enter ID of Staff to be deleted", "Enter Staff ID", NORMAL);
        
        if (id != null) {
            String condition = "Staff_id = '" + id + "'";

            Connection connection = SQLServer.getConnection();
            SQLServer.deleteData("staff", condition);
